...
app = MultiPage(app_name="Cherry Leaf Mildew Analysis")  # Create an instance of the app

# Add your app pages here using .add_page()
app.app_page("Quick Project Summary", page_summary_body)
app.app_page("Cherry Leaf Mildew Visualiser", page_mildew_visualizer_body)
app.app_page("Cherry Leaf Mildew Detection", page_mildew_detector_body)
